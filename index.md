...
portable version with the function
[`configure_jwsacruncher()`](reference/configure_jwsacruncher.md).

## Usage

The JWSACruncher can be easily runned with the function
[`cruncher_and_param()`](reference/cruncher_and_param.md). To use it,
the path to the “Bin” folder of the JWSACruncher has to be defined. For
example, if the JWSACruncher is under `D:/jdemetra-cli-2.2.3/`:
