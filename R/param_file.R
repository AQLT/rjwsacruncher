...
default_param_file <- function(v3 = getOption("is_cruncher_v3")){
  v3_param <- 
    list(config = list(bundle = "10000", csv_layout = "list", csv_separator = ";", 
                       ndecs = "6", full_series_name = TRUE, rslt_name_level = "2", 
                       format = "JD3"), policy = "parameters", refreshall = TRUE, 
         output = NULL, matrix_item = c("period", "span.start", "span.end", 
                                        ...
                                        "m-statistics.q-m2"), tsmatrix_series = c("residuals.tsres", 
                                                                                  ...
                                                                                  "finals.e2", "finals.e3", "finals.e11"), paths_path = NULL)
  v2_param <- 
    list(config = list(bundle = "10000", csv_layout = "list", csv_separator = ";", 
         ...
         output = NULL, matrix_item = c("period", "span.start", "span.end", 
                                        ...
                                        "diagnostics.quality"), tsmatrix_series = c("y", "y_f", "y_ef", 
                                                                                    ...
                                                                                    "decomposition.sa_cmp_ef", "decomposition.si_cmp"), paths_path = NULL)
  if (v3) {
    v3_param
  } else {
    v2_param
